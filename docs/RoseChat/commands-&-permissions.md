...
|                   | Allows using hex color in different places. | rosechat.hex.channel.<channel\> <br/> rosechat.hex.chatcolor <br/> rosechat.hex.group <br/> rosechat.hex.message <br/> rosechat.hex.nickname |
